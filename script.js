...
async function fetchPokemonData(pokemonId) {
    try {
        ...
        const response = await fetch(`https://cors-anywhere.herokuapp.com/https://pokeapi.co/api/v2/pokemon/${id}`);
        ...
        alert(`Error al buscar Pokémon: ${error.message}. Intenta con un ID válido (ej. 25).`);
        return null;
    }
}
